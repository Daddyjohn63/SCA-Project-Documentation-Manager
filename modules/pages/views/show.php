...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('pages/manage', 'View All Pages', array("class" => "button alt"));
        echo anchor('pages/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('pages/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete a Page record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 
